...
function [ trainingAccuracy,validatingAccuracy,inputWeight,bias,isMinimumGap,currentGroupStatus ] = initialTraining( trainingData,validatingData,neuronCount,activationMethod,iteration )

dataForVisual = zeros(iteration,2);
allInputWeightAndBias = cell(iteration,2);
for i=1:1:iteration
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,iw,b] = ELM(trainingData, validatingData, 1, neuronCount, activationMethod);
